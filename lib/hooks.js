...
export function useBookmark(props) {
  ...
  const handleClick = () => {
    ...
    fetch(`http://tech-news-backend.vercel.app/users/canBookmark/${user.token}`)
      .then((res) => res.json())
      .then((data) => {
...
export function useFetchArticles() {
  ...
  useEffect(() => {
    fetch("http://tech-news-backend.vercel.app/articles")
...
export function useRegister() {
  ...
  function handleRegister() {
    ...
    fetch("http://tech-news-backend.vercel.app/users/signup", {
      method: "POST",
...
export function useConnect() {
  ...
  function handleConnect() {
    fetch("http://tech-news-backend.vercel.app/users/signin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
